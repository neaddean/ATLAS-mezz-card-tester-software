...
parser.add_argument("-f", help="name of data file w/o number", default = "channel")
parser.add_argument("-p", "--plot", help="plot sweep data flag", action="store_true",
                    default = False)
parser.add_argument("-d", help="name of dac data file", default = "dac.txt")
parser.add_argument("-dp", "--dacplot", help="plot dac flag", action="store_true",
                    default = False)
