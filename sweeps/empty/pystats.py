...
parser.add_argument("-p", "--plot", help="plotting flag", action="store_true",
                    default = False)
...
if should_plot:
    ...
    for i in range(0, 24):
        temp_fig, temp_popt = process_file("longsweep"+str(i))
    ...
    for i in range(0, 24):
        popt_list.append(process_file("longsweep"+str(i)))
